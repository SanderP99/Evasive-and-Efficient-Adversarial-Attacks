...
if __name__ == '__main__':
    ...
    for n_experiment in n_experiments:
        for experiment_id in experiment_ids[::n_experiment]:
            for nodes in n_nodes:
                for particles in n_particles:
                    for distribution_scheme in distribution_schemes:
                        ...
                        scheme = CombinationDistributionScheme(None, n_experiments=n_experiment)

                        exps = []
                        for j in range(min(n_experiment, 20 - experiment_id)):
                        ...
                        previous_queries = 0
                        new_queries = 0
                        with tqdm(total=max_queries * n_experiment) as pbar:
                            while attack.total_queries < n_experiment * max_queries:
                                attack.attack()
