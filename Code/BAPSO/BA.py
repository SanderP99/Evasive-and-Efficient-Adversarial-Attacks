...
def boundary_attack():
    ...
    mnist = MNIST()
    initial_sample = preprocess('images/awkward_moment_seal.png')
    target_sample = preprocess('images/bad_joke_eel.png')
    ...
    while True:
        ...
        while True:
            ...
            trial_samples = np.array(trial_samples).reshape((10, 224, 224, 3))
