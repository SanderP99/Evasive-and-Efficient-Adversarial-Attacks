...
%%% TITLE PAGE INFO:
\title[Distributed Adversarial Attacks]{Evading stateful defense while crafting adversarial examples using particle swarm optimization} %[]] will appear in footline
