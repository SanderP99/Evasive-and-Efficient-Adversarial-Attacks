...
\begin{quote}
Imperceptibly small perturbations to a correctly classified input image, so that it is no longer classified correctly. \footcite{szegedy2014intriguing}
\end{quote}
