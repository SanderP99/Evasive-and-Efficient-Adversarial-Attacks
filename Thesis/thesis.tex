...
title={Efficient and Evasive Distributed Adversarial Attacks using Particle Swarm Optimization},
%
...
assessor={Prof. dr. D. Devriese \and I. Tsingenopoulos},
assistant={I. Tsingenopoulos \and V. Rimmer}
}
...
\usepackage{tikz}
\usetikzlibrary{positioning, intersections, calc, angles, spath3, quotes, shapes.geometric}
...
\newacronym{mgrr}{MGRR}{Multi-Group with Random Redistribution}
...
\appendix
%\include{Chapters/surfree_calculations}
\include{Chapters/parameter_table}
